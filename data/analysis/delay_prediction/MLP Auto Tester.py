...
alpha_value = [0.001, 0.01, 0.05, 0.1, 0.5, 1, 5, 10, 50, 100, 500] #0.1 -> ~65%, 1.0 -> ~60%
...
hidden_layer_comp = [(20,10,5,), (20,10,), (50,25,), (100,50,), (500, 100,), (20,), (50,), (100,), (500,)]#(100,50)#(20,10,5,)
...
for num, row in enumerate(csv_data_list[1:200000]): #[1:300000]
...
with open("MLP_" + str(total_combos) + "_combos_" + str(num_iter) + "_iters.csv", "w", newline='') as fo:
