...
#Set max and mix values to guess between based on largest and smallest data in the test set
rand_min = min(y)
print("Min:", rand_min)
rand_max = max(y)
print("Max:", rand_max)
...
for i in range(num_iter):
	...
	predictions = [int(round_base * round(float(random.randint(rand_min, rand_max))/round_base)) for x in range(len(y_test))]
